<div>
    <div class="bg-blue-500 px-4 py-3 text-white">
        <p class="text-center text-sm font-medium">
            Mau Dapat Promo?
            <a href="https://www.instagram.com/jimmy27_javarentcar/?hl=en" class="inline-block underline">Cek
                Instagram Kami Sekarang</a>
        </p>
    </div>
    <section class="bg-white dark:bg-white md:mt-40 md:mb-48 lg:mt-40 lg:mb-48">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <a href="https://www.instagram.com/jimmy27_javarentcar/?hl=en"
                class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-neutral-50 dark:text-black hover:bg-gray-200 dark:hover:bg-neutral-200 transition-all"
                role="alert">
                <span class="text-xs bg-blue-500 rounded-full text-white px-4 py-1.5 mr-3">Update</span> <span
                    class="text-sm font-medium">Lihat Update Terbaru Dari Kami</span>
            ...
            <h1
                ...
                Welcome to <span data-popover-target="popover-default"
                    class="hover:text-blue-500 transition-all delay-100">Java RentCar</span> Purwokerto
            </h1>
            <div data-popover id="popover-default" role="tooltip"
                class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-xs opacity-0 dark:text-gray-400 dark:border-nutral-200 dark:bg-white">
                <div
                    class="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg dark:border-neutral-200 dark:bg-white">
                    <h3 class="font-semibold text-gray-900 dark:text-black">Kunjungi Lokasi Kami</h3>
                </div>
                <div class="px-3 py-2">
                    <a class="underline text-blue-500 pointer-events-auto"
                        href="https://www.google.co.id/search?q=java+rent+car+purwokerto&sca_esv=b71b87a039ad9bf1&source=hp&ei=4LOiZ7vXNsKZ4-EPzPCD-AU&iflsig=ACkRmUkAAAAAZ6LB8KXWmHd7_UFOqt3TckgSXuS2cg-w&oq=java+rentcar+pu&gs_lp=Egdnd3Mtd2l6Ig9qYXZhIHJlbnRjYXIgcHUqAggAMgYQABgWGB4yBRAAGO8FMgUQABjvBTIFEAAY7wUyBRAAGO8FSOI7UABYny5wAHgAkAEAmAGwAqAB1Q6qAQc3LjYuMS4xuAEDyAEA-AEBmAIPoALzDsICBxAAGIAEGBPCAgkQABiABBgTGArCAggQABgTGBYYHsICAhAmmAMAkgcHNi43LjEuMaAHw04&sclient=gws-wiz">Lokasi
                        Java RentCar</a>
                </div>
                <div data-popper-arrow></div>
            </div>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                Tempat penyewaan mobil terlengkap di purwokerto mulai dari yang mobil biasa aja sampai yang bisa di
                pakai buat traveling keluarga</p>
            <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <a href="{{ route('product') }}"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 transition-all">
                    Sewa Sekarang
                ...
                <a href="#"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-black dark:border-neutral-100 dark:hover:bg-blue-500 dark:focus:ring-gray-800 transition-all hover:text-white">
    ...
    <section id="product" class="text-gray-600 body-font -mt-24">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-left w-full mb-6">
                <h2 class="text-lg text-indigo-500 tracking-widest font-medium title-font">Best Product</h2>
                <h1 class="sm:text-3xl text-2xl font-medium text-gray-900">Berikut Mobil Unggulan Kami</h1>
            </div>
            <!-- Update layout to 2 columns -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="#" class="block rounded-lg p-4 border border-solid border-gray-200">
                    <img alt="xpander" src="{{ asset('images/xpander.jpg') }}"
                    ...
                    <div class="mt-2">
                        <dl>
                            <div>
                                ...
                                <dd class="text-sm text-gray-500">Rp 400.000,00</dd>
                            </div>

                            <div>
                                <dt class="sr-only">Address</dt>

                                <dd class="font-medium">Mitsubishi Xpander New</dd>
                            </div>
                        </dl>
                        ...
                        <div class="mt-6 flex items-center gap-8 text-xs">
                            <div class="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
                                ...
                                <div class="mt-1.5 sm:mt-0">
                                    ...
                                    <p class="font-medium">4+2 Seat</p>
                                </div>
                            </div>

                            <div class="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
                                <svg class="text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div class="mt-1.5 sm:mt-0">
                                    ...
                                    <p class="font-medium">Putih, Hitam, Silver</p>
                                </div>
                            </div>
    ...
    <section id="benefits" class="text-gray-600 body-font -mt-24">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-left w-full mb-6">
                <h2 class="text-lg text-indigo-500 tracking-widest font-medium title-font">Benefits
                </h2>
                <h1 class="sm:text-3xl text-2xl font-medium text-gray-900">Keuntungan Sewa Di JavaRent
                </h1>
            </div>
            <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/3">
                    <div class="flex rounded-lg h-full border border-solid border-gray-200 p-8 flex-col">
                        <div class="flex items-center mb-3">
                            ...
                            <h2 class="text-gray-900 text-lg title-font font-medium">Mobil Bersih dan Nyaman</h2>
                        </div>
                        <div class="flex-grow">
                            <p class="leading-relaxed text-base">Mobil milik kami selalu kami jaga kebersihan nya agar
                                customer kami juga nyaman saat memakai nya di perjalanan.</p>
                        </div>
                    </div>
                </div>
                <div class="p-4 md:w-1/3">
                    <div class="flex rounded-lg h-full border border-solid border-gray-200 p-8 flex-col">
                        <div class="flex items-center mb-3">
                            ...
                            <h2 class="text-gray-900 text-lg title-font font-medium">Harga Yang Terjangkau</h2>
                        </div>
                        <div class="flex-grow">
                            <p class="leading-relaxed text-base">Kami memiliki varian harga yang masih ramah di kantong
                                dan pastinya terjangkau dan worth it untuk kalian.</p>
                        </div>
                    </div>
                </div>
                <div class="p-4 md:w-1/3">
                    <div class="flex rounded-lg h-full border border-solid border-gray-200 p-8 flex-col">
                        <div class="flex items-center mb-3">
                            ...
                            <h2 class="text-gray-900 text-lg title-font font-medium">Varian Mobil Beragam</h2>
                        </div>
                        <div class="flex-grow">
                            <p class="leading-relaxed text-base">Kami memiliki pilihan mobil yang beragam dengan tipe
                                tertinggi nya dan pasti nya keluaran terbaru.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="text-gray-600 body-font -mt-24">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-left w-full mb-6">
                <h2 class="text-lg text-indigo-500 tracking-widest font-medium title-font">Testimonial
                </h2>
                <h1 class="sm:text-3xl text-2xl font-medium text-gray-900">Pendapat Pelanggan Kami
                </h1>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row md:-mx-3">
                        <div class="flex-1 px-3">
                            <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8">
                                <p class="text-xl font-semibold">Review Terbaik Dari Pak Yanto

                                </p>
                                <p class="mt-6">"Saya sangat suka sewa disini mobilnya bersih harga nya murah dan
                                    yang pasti mobil nya tidak pernah ada trouble"
                                </p>
                                <div class="flex items-center mt-8"><img class="w-12 h-12 mr-4 rounded-full"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Kepala Keluarga
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex-1 px-3">
                            <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8">
                                <p class="text-xl font-semibold">Review Terbaik Dari Pak Kevin

                                </p>
                                <p class="mt-6">Mantep bener sewa disini mobil nya beragam tahun tahun terbaru juga
                                    jadi gak worry kalau buat mudik jauh.
                                </p>
                                <div class="flex items-center mt-8"><img class="w-12 h-12 mr-4 rounded-full"
                                        src="https://penguinui.s3.amazonaws.com/component-assets/avatar-9.webp"
                                        alt="John Doe">
                                    <div>
                                        <p>Kevin Jonathan
                                        </p>
                                        <p class="text-sm text-gray-600">Mahasiswa akhir UI
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex-1 px-3">
                            <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8">
                                <p class="text-xl font-semibold">Review Terbaik Dari Ibu Jane Smith

                                </p>
                                <p class="mt-6">Pelayanan nya baik juga ramah cocok untuk perjalanan keluarga.
                                    Mobilnya juga nyaman dan bersih!
                                </p>
                                <div class="flex items-center mt-8"><img class="w-12 h-12 mr-4 rounded-full"
                                        src="https://penguinui.s3.amazonaws.com/component-assets/avatar-3.webp"
                                        alt="Jane Smith">
                                    <div>
                                        <p>Jane Smith
                                        </p>
                                        <p class="text-sm text-gray-600">Direktur Shinwa
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<footer class="bg-white dark:bg-white pl-4">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-black">JavaRent</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-neutral-400">Resources</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Lokasi</a>
                        </li>
                        <li>
                            <a href="https://tailwindcss.com/" class="hover:underline">S&K Penyewaan</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-neutral-400">Follow us</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-neutral-400">Kontak</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">WhatsApp</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline">DM Instagram</a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <hr class="my-6 border-gray-200 sm:mx-auto dark:border-neutral-200 lg:my-8" />
